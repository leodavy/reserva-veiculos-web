  ...
  <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
    ...
    <form>
      <div class="mb-4">
        ...
        <input type="login" id="login" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
      </div>
      <div class="mb-6">
